    ...
    responses: [
      {
        ...
        message:
          "Su solicitud ha sido recibida y está siendo evaluada por nuestro equipo.",
      },
      {
        date: new Date("2024-01-18"),
        author: "Coordinador de Programas",
        message:
          "Se ha programado visita domiciliaria para verificar la situación familiar.",
      },
      {
        date: new Date("2024-01-20"),
        author: "Director de Desarrollo Social",
        message:
          "Solicitud aprobada. Se autorizó entrega de despensa mensual por 3 meses.",
      },
    ],
    followUps: [
      {
    ...
    responses: [
      {
        ...
        message:
          "Su solicitud ha sido recibida. Se requiere documentación médica adicional.",
      },
      {
        date: new Date("2024-01-25"),
        author: "Coordinador de Salud",
        message:
          "Documentación recibida. Se está evaluando con el comité médico.",
      },
    ],
    followUps: [
      {
        ...
        details:
          "Expediente enviado al comité médico municipal para evaluación.",
      },
    ],
  },
  {
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold text-slate-800">
          {audiences.length} audiencia{audiences.length !== 1 ? "s" : ""}{" "}
          {title.toLowerCase()}
        </h3>
      </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          <Badge
                            className={
                              CATEGORIES[
                                audience.category as keyof typeof CATEGORIES
                              ].color
                            }
                          >
                            {
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 w-full sm:w-auto">
              <Button
                asChild
                variant="outline"
                className="border-blue-200 text-blue-700 hover:bg-blue-50 text-xs sm:text-sm px-3 sm:px-4 py-2 flex-1 sm:flex-none"
              >
                <Link
                  to="/"
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 py-4 sm:py-8">
        <Tabs defaultValue="all" className="space-y-6">
          ...
          <TabsContent value="all" className="space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-slate-800">
                {filteredAudiences.length} audiencia
                {filteredAudiences.length !== 1 ? "s" : ""} encontrada
                {filteredAudiences.length !== 1 ? "s" : ""}
              </h3>
            </div>
          ...
          <TabsContent value="pending">
            <AudienceList
              audiences={filteredAudiences.filter(
          ...
          {selectedAudience && (
            <div className="space-y-6">
              ...
              <div className="bg-slate-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {selectedAudience.meetingFormat === "presencial"
                        ? "Presencial"
                        : "En línea"}
                    </p>
                  </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {selectedAudience.responses?.map(
              ...
              <div>
                ...
                <div className="space-y-3">
                  {selectedAudience.followUps?.map(
                          ...
                          <div className="flex items-center gap-2">
                            <div
                              className={`w-3 h-3 rounded-full ${
                                followUp.status.includes("realizada")
                                  ? "bg-green-500"
                                  : followUp.status.includes("pendiente")
                                    ? "bg-yellow-500"
                                    : "bg-blue-500"
                              }`}
                            ></div>
